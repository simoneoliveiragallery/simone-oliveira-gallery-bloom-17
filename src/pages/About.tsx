...
const About = () => {
  ...
  const websiteStructure = [{
    ...
    icon: "📰",
    title: "Coleções e Imprensa",
    description: "Histórico de coleções, reportagens, entrevistas e reconhecimentos conquistados ao longo da trajetória artística."
  }, {
    icon: "📞",
    title: "Contato",
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            {/* Processo Criativo */}
            <div className="group cursor-pointer flex justify-center">
              <div className="w-full aspect-square overflow-hidden rounded-2xl shadow-elegant bg-soft-beige flex items-center justify-center">
                <img src="/lovable-uploads/46d52c97-6c40-4984-b6b2-229797103846.png" alt="Processo criativo - aplicação de tinta" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
            </div>
          </div>
        </div>
