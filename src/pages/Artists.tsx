    ...
    <section className="px-4 sm:px-6 lg:px-8 pb-20 bg-gentle-green/10">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-helvetica text-lg text-deep-black/80 max-w-2xl mx-auto justified-text text-center">Meu processo criativo é fundamentado em três pilares essenciais que orientam cada obra, que confere às criações uma identidade única, sensível e conectada com o observador.</p>
        </div>
